...
* FROZEN COPY -- #169 historical control (variant H). NOT the design.
*
* This is design/ldo_3v3in_1v8out.sch byte-for-byte as it stood at commit
* 64c17cb -- the merge of #81's own PR (#87), i.e. the circuit #81 item 2's
* 125 C / 50 mA transient was run against -- before #90 re-sized the thermal
* shutdown and #116/DR-011 re-sized the pass device. Only this comment block
* and the file name differ (verify: `git show 64c17cb:design/ldo_3v3in_1v8out.sch
* | diff - <this file>`). It lives here so #169 can re-run #81's check against
* #81's circuit from committed files; it is instantiated only by
* sim/ic-screen-125c-h/testbench/. Do not "fix" it forward -- its whole
* evidentiary value is being the historical circuit. The live design is
* design/ldo_3v3in_1v8out.sch.
*
