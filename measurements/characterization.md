...
- **Dropout @ 50 mA**: **FAIL** (vs the ratified spec row) — `sim/dropout-vs-load` record [`20260923-123440-d71f4b3`](../sim/dropout-vs-load/records/20260923-123440-d71f4b3.md), 6/45 corner(s) PASS. Freshness: fresh (a live xschem re-netlist of the current testbench schematic matches the committed netlist snapshot verbatim).
...
- **Thermal**: **FAIL** (vs the ratified spec row) — `sim/thermal` record [`20260825-104426-933dfdd`](../sim/thermal/records/20260825-104426-933dfdd.md), 12/15 corner(s) PASS. Freshness: STALE (a live xschem re-netlist of the current testbench schematic no longer matches the committed netlist snapshot).
...
- **Stability**: **FAIL** (vs the ratified spec row) — `sim/loop-gain` record [`20260825-081257-4cb27f8`](../sim/loop-gain/records/20260825-081257-4cb27f8.md), 7/45 corner(s) PASS. Freshness: STALE (a live xschem re-netlist of the current testbench schematic no longer matches the committed netlist snapshot).
