...
| Load regulation (0–50 mA) | < 1% (18 mV), counted inside the ±2% window | **FAIL** | [`20260925-111601-7701e7e`](../sim/load-regulation/records/20260925-111601-7701e7e.md) | fresh |
...
- **Load regulation (0–50 mA)**: **FAIL** (vs the ratified spec row) — `sim/load-regulation` record [`20260925-111601-7701e7e`](../sim/load-regulation/records/20260925-111601-7701e7e.md), 37/45 corner(s) PASS. Freshness: fresh (a live xschem re-netlist of the current testbench schematic matches the committed netlist snapshot verbatim). Failing measurement(s), per the record: `load_reg_v` at 8 corner(s); `load_reg_pct` at 8 corner(s).
