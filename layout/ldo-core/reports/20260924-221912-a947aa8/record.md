...
| Stage | Status | Detail |
| --- | --- | --- |
| Extract | extracted | device_count=97, net_count=28, pin_count=4, device_counts={'nfet': 18, 'pfet': 74, 'res_high_po': 1, 'res_xhigh_po': 4} |
...
- Record ID: `20260924-221912-a947aa8`
...
- Schematic freshness: `design/ldo_3v3in_1v8out.sch` as of commit `ad02544`.
- Layout freshness: `layout/ldo-core/` as of commit `3810ce0`; GDS taken from layout record `20260924-221821-a947aa8`.
- Repo state: `a947aa840730c01c32c8134b382449d45edf5de1` on `feature/issue-154` (dirty)
