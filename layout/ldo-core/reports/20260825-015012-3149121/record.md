# LDO core layout record: 20260825-015012-3149121
...
| bias_enable | M_BIASN1, M_ENN, M_BIASN2, M_ENN2, M_BIASP1, M_ENP2, M_ENP, M_ENP5, M_ENP3, M_ENP4 | 2122.20 | 2244.66 | 11.12 |
...
- Record ID: `20260825-015012-3149121`
...
- Schematic freshness: `design/ldo_3v3in_1v8out.sch` as of commit `fdd6ebf` (see `design/README.md`'s own Freshness note). This record's device set was read from that schematic at run time, not from a table.
- Repo state: `31491210e4bd26d5cb99488a51149f6134ee5a6d` on `feature/issue-59` (dirty)
