...
- Record ID: `20260818-034303-d0b244d`
...
- Schematic freshness: `design/ldo_3v3in_1v8out.sch` as of commit `d0b244d`.
- Layout freshness: `layout/ldo-core/` as of commit `879f035`; GDS taken from layout record `20260818-034016-d0b244d`.
