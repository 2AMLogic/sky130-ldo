...
- Record ID: `20260825-015029-3149121`
...
- Schematic freshness: `design/ldo_3v3in_1v8out.sch` as of commit `fdd6ebf`.
- Layout freshness: `layout/ldo-core/` as of commit `fc2fa04`; GDS taken from layout record `20260825-015012-3149121`.
