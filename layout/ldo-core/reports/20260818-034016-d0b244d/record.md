# LDO core layout record: 20260818-034016-d0b244d
...
- Cell name: `ldo_core`
- Block count: 48
- Placed bbox (um), before routing: {'x0': 0.0, 'y0': 0.0, 'x1': 2382.0799999999995, 'y1': 101.12}
- Device row: 2384.08um x 101.12um
...
| bias_enable | M_BIASN1, M_ENN, M_BIASN2, M_ENN2, M_BIASP1, M_ENP2, M_ENP, M_ENP4, M_ENP3, M_ENP4__2 | 2122.20 | 2244.66 | 11.12 |
| error_amp | M_MIR1, M_MIR2, M_MIR3, M_MIR4, M_TAIL, M_IN1, M_IN2, M_MIRP1, M_MIRP2, M_IN2S | 2136.56 | 2279.50 | 41.12 |
| current_limit | M_CLN1, M_CLN2, M_SENSE, M_CLP, M_CLIM | 2163.92 | 2290.92 | 21.12 |
| soft_start | M_INVN, M_SSDIS, M_INVP, M_SSCHG | 2171.60 | 2305.70 | 3.12 |
| thermal_shutdown | M_TSD1, M_TSD2, M_TSR1, M_TCTAIL, M_TCN1, M_TCN2, M_TSPS, M_TSPR, M_TCP1, M_TCP2, M_TSHUT, M_TSHYSB, M_TSHYS | 2178.28 | 2336.68 | 80.82 |
| output_pass | M_PASS | 2338.68 | 2382.08 | 101.12 |
...
- Record ID: `20260818-034016-d0b244d`
...
- Schematic freshness: `design/ldo_3v3in_1v8out.sch` as of commit `d0b244d` (see `design/README.md`'s own Freshness note). This record's device set was read from that schematic at run time, not from a table.
- Repo state: `d0b244d3c5791c087cfd96b2009aee3b299c5fec` on `feature/issue-33` (dirty)
